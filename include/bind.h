...
namespace wsd {
    ...
    bind(Functor functor, const A1& a1)
    {
        ...
        // the original. 
        STATIC_ASSERT(!is_non_const_reference<typename detail::FunctionTraits<RunType>::A1Type>::value,
        ...
        STATIC_ASSERT(!is_raw_pointer<A1>::value, do_not_pass_raw_pointers_as_bound_argument);
    ...
    bind(Functor functor, const A1& a1, const A2& a2)
    {
        ...
        // memory leak. Use wsd::unretained(), wsd::owned() to specify the memory
        // ownership explicitly.
        STATIC_ASSERT(!is_raw_pointer<A1>::value
